...
export const BASE_PROJECT: Project = {
  ...
  lucky: {
    ...
    images: [],
    objectCounts: [...branding.lucky.objectCounts],
    colorSchemes: [...branding.lucky.colorSchemes],
    surfaces: [...branding.lucky.surfaces],
    blendModes: [...branding.lucky.blendModes],
    textBackdrops: [...branding.lucky.textBackdrops],
    animation: branding.lucky.animation,
    enabledEffectIds: [
      "ripple",
      "wave",
      "twist",
