...
export function defaultProject(): Project {
  return {
    ...
    segments: [
      ...
      { id: uid('seg'), kind: 'animation', label: 'Continue', durationSec: 2.5 },
      {
        id: uid('seg'),
        kind: 'text',
        label: 'Text 2',
      ...
      { id: uid('seg'), kind: 'animation', label: 'Conclude', durationSec: 2.5 },
      {
        id: uid('seg'),
        kind: 'text',
        label: 'Closing',
